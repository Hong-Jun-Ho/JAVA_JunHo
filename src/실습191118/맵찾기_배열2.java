...
/*********************************************************
* 메소드명 : 이동 파라메터 : 입력받은 방향 방향 코드 설명 위쪽 1 맵의 배열에 행의 값을 1 감소 하여 이동한다. 
...
switch (방향) {
case "1":
if (맵[변경위치[0] - 1][변경위치[1]] == 1) {
	맵[변경위치[0] - 1][변경위치[1]] = 2;
	맵[변경위치[0]][변경위치[1]] = 1;
	변경위치[0]--;
} else {
	System.out.println("-------------경고------------ 벽입니다!! ");
}
break;
